...
class _HomeMainState extends State<HomeMain> {
  ...
  // fungsi yang berfungsi untuk mengecek
  // koneksi internet di saat aplikasi
  // sedang berjalan
  WillPopScope showConnectionStatus(ConnectivityResult result) {
    if (result == ConnectivityResult.wifi) {
  ...
  // kondisi user interface
  // jika terkoneksi dengan internet

  // fungsi yang berjalan untuk
  // menampilkan beberapa obejk di dalam konten layout
  WillPopScope stateConnectionInternet() {
    return WillPopScope(
                ...
                child: Stack(
                  children: [
                    InAppWebView(
                      key: webKey,
                      initialUrlRequest:
                          URLRequest(url: Uri.parse(flutterDevURL)),
  ...
  // fungsi yang berjalan untuk
  // menghandle dan menampilkan pop up menu
  // jika exit dari app
  ...
  // kondisi user interface
  // sedang tidak terkoneksi dengan internet

  // fungsi yang berjalan menampilkan
  // beberapa objek di dalam konten layout
  WillPopScope stateNoConnectionInternet() {
    return WillPopScope(
        onWillPop: onNotConnectInternetBackPressed,
        child: Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
  ...
  // fungsi yang berjalan untuk
  // menghandle dan menampilkan dialog menu jika
  // exit dari app
  Future<bool> onNotConnectInternetBackPressed() async {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
